 ...
 *
 * Requires: Referer header from trusted origin OR X-ORION-Key header.
 * Uses api.orion.app by default.
 */
...
const API_KEY = process.env.ORION_KEY || '';
