// Phase 3b: LLM enrichment for the ORION Brief envelope.
//
 ...
 * server/orion/intelligence/v1/brief-why-matters-prompt.ts
...
const STORY_DESCRIPTION_SYSTEM =
  'You are the editor of ORION Brief, a geopolitical intelligence magazine. ' +
...
const DIGEST_PROSE_SYSTEM_BASE =
  'You are the chief editor of ORION Brief. Given a ranked list of ' +
