...
const HANDLERS_ROOT = join(REPO_ROOT, 'server', 'orion');
...
// imported by `server/orion/<service>/<version>/handler.ts`).
...
function resolveHandlerFile(service, version, operationId) {
  ...
  return {
    ...
    handlerRelPath: `server/orion/${service}/${version}/${basename}.ts`,
