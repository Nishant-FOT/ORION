 ...
 *
 * Authentication:
 *   - WM_MCP_KEY sends X-ORION-Key: <key>
 *   - WM_MCP_OAUTH_TOKEN sends Authorization: Bearer <token>
 *
 * Endpoint defaults to https://orion.app/mcp; override with
 * ORION_MCP_ENDPOINT for staging.
 */
...
const ENDPOINT = process.env.ORION_MCP_ENDPOINT ?? 'https://orion.app/mcp';
...
else headers['X-ORION-Key'] = API_KEY;
