...
// without a usable discovery timestamp. We persist a ORION-observed
...
// Issue #4008 — pure merge of ORION-observed first-seen. Resolves one
...
async function fetchAllThreats() {
  ...
  // ORION-observed) before sort/proto so `firstSeenAt` is populated for
