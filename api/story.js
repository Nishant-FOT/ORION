...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://orion.app');
  ...
  const title = `${countryName} Intelligence Brief | ORION`;
...
<head>
  ...
  <meta name="twitter:site" content="@ORIONApp"/>
