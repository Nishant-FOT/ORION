...
import { buildActionEvents } from '../server/orion/intelligence/v1/chat-analyst-actions';
  ...
  if (req.method === 'OPTIONS') {
    return new Response(null, {
      ...
      headers: {
        ...
        'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-ORION-Key, X-Api-Key',
      },
    });
  }
