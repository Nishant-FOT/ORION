...
export function extractConvexErrorKind(err, msg) {
  ...
  // with back-off. ORION-QE: was previously falling through to the
  ...
  // retry-with-back-off remediation as the platform 503. ORION-PG: was
  ...
  // at error level (ORION-PG: 11 events / 9 users). Sentry's
