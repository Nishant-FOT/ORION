...
// AbortSignal.timeout. Empirically (ORION-QJ — 4 events / 19 days,
 ...
 * ORION_PUBLIC_BASE_URL in production to prevent host-header
...
function publicBaseUrl(req: Request): string {
  const pinned = process.env.ORION_PUBLIC_BASE_URL;
