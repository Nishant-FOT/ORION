...
const BOOTSTRAP_CACHE_KEYS = {
  ...
  fredUnemployment:     'economic:fred:v1:UNRATE:0',
  fredCpi:              'economic:fred:v1:CPIAUCSL:0',
  fredDgs10:            'economic:fred:v1:DGS10:0',
  fredDgs2:             'economic:fred:v1:DGS2:0',
  fredDcoilwtico:       'economic:fred:v1:DCOILWTICO:0',
  fredTwexb:            'economic:fred:v1:TWEXB:0',
  fredWalcl:            'economic:fred:v1:WALCL:0',
  fredM2sl:             'economic:fred:v1:M2SL:0',
  fredGfdebtn:          'economic:fred:v1:GFDEBTN:0',
  fredStlfsi4:          'economic:fred:v1:STLFSI4:0',
  fredGdp:              'economic:fred:v1:GDP:0',
  fredIcsa:             'economic:fred:v1:ICSA:0',
  fredVixcls:           'economic:fred:v1:VIXCLS:0',
  fredT10y2y:           'economic:fred:v1:T10Y2Y:0',
  fredBaml:             'economic:fred:v1:BAMLH0A0HYM2:0',
  fredSofr:             'economic:fred:v1:SOFR:0',
  fredMortgage30:       'economic:fred:v1:MORTGAGE30US:0',
...
// No public/s-maxage: CF (in front of api.orion.app) ignores Vary: Origin and would
// pin ACAO: orion.app on cached responses, breaking CORS for preview deployments.
