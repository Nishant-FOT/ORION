...
ORION's Energy Atlas publishes evidence bundles — not opinions —
...
- **Evidence bundles on every asset.** Click any pipeline, storage
  facility, or shortage pin on the Energy Atlas and you see its full evidence bundle: physical state, commercial
...
- An automated correction-intake pipeline. If you spot something
  ...
  [orion.app](https://orion.app) or open a GitHub issue
  at the [public repository](https://github.com/orion-energy-resilience/orion/issues).
