...
description: "How ORION scores 13 monitored maritime chokepoints, including the seven-item live-flow subset with EIA energy baselines."
---

## What we track

ORION has **13 monitored waterways** in the canonical chokepoint registry and the
...
`server/orion/supply-chain/v1/get-chokepoint-status.ts` and weighted in
`server/orion/supply-chain/v1/_scoring.mjs`.
...
[public repository](https://github.com/orion-energy-resilience/orion/issues).
