...
description: "Premium finance is the finance-variant layer providing stock-analysis capabilities within ORION, originally inspired by a standalone daily_stock_analysis project but now fully integrated."
---
Premium finance is the finance-variant layer providing stock-analysis capabilities within ORION. These features were originally inspired by a standalone `daily_stock_analysis` project but are now fully integrated into the ORION codebase.
...
3. Premium endpoints require `ORION_API_KEY` server-side, not just a locked UI.
