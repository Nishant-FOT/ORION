...
- **Availability**: registered and enabled by default in the **full/geopolitical** and **finance** configurations — locked in both. Not present in the tech, commodity, or happy configurations. Source: `'stock-backtest'` entries in `FULL_PANELS` (`:50`) and `FINANCE_PANELS`.
