...
- **Availability**: registered in the **full/geopolitical** configuration only, and **disabled by default**. Users must opt into it. Not present in the tech, finance, commodity, or happy configurations.
