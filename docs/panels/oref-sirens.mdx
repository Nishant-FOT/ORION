...
- **Availability**: registered and enabled by default in the **full/geopolitical** configuration only (`priority: 2`). Not present in the tech, finance, commodity, or happy configurations. Source: `'oref-sirens'` in `FULL_PANELS` of `src/config/panels.ts`.
