...
- **Availability**: registered and enabled by default in the **full/geopolitical** configuration only. Not present in the tech, finance, commodity, or happy configurations. Source: `FULL_PANELS` in `src/config/panels.ts`.
...
AI Forecasts is freely accessible on the web.
