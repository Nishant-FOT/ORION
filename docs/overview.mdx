...
description: "ORION platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
ORION runs six specialized variants from a single codebase, each optimized for different monitoring needs.

## Platform Variants

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 ORION** | [orion.app](https://orion.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.orion.app](https://tech.orion.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
| **😊 Happy Monitor** | [happy.orion.app](https://happy.orion.app) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.orion.app](https://finance.orion.app) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.orion.app](https://commodity.orion.app) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
| **⚡ Energy Monitor** | [energy.orion.app](https://energy.orion.app) | Oil & gas pipelines, storage facilities, tanker positions, chokepoints, energy infrastructure and shocks |
...
The tech variant ([tech.orion.app](https://tech.orion.app)) provides specialized layers for technology sector monitoring.
...
The finance variant ([finance.orion.app](https://finance.orion.app)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.orion.app](https://commodity.orion.app)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.orion.app](https://happy.orion.app)) curates positive news, human progress data, and uplifting stories.
