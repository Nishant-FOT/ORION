...
description: "ORION platform capabilities and specialized monitoring configurations for geopolitical, technology, finance, commodity, and energy intelligence."
---
ORION is a single platform at [orion.app](https://orion.app) that provides specialized monitoring configurations for different intelligence domains. You can switch between focus areas using the variant selector in the header, which preserves your map position and panel configuration.
...
The Tech Monitor configuration provides specialized layers for technology sector monitoring.
...
The Finance Monitor configuration provides specialized layers for global financial markets and economic intelligence.
...
The Commodity Monitor configuration focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The Happy Monitor configuration curates positive news, human progress data, and uplifting stories.
