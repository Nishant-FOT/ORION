...
- [stock-news-search.ts](https://github.com/orion-energy-resilience/orion/blob/main/server/orion/market/v1/stock-news-search.ts)
...
The search layer uses runtime-managed secret keys so it fits the same native/web secret model as the rest of the project.
...
- [runtime-config.ts](https://github.com/orion-energy-resilience/orion/blob/main/src/services/runtime-config.ts)
- [settings-constants.ts](https://github.com/orion-energy-resilience/orion/blob/main/src/services/settings-constants.ts)
- [main.rs](https://github.com/orion-energy-resilience/orion/blob/main/src-tauri/src/main.rs)
- [local-api-server.mjs](https://github.com/orion-energy-resilience/orion/blob/main/src-tauri/sidecar/local-api-server.mjs)
