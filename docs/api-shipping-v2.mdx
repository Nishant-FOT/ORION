...
The v2 shipping API is a read + webhook-subscription surface on top of ORION's chokepoint registry and AIS tracking data.
...
Auth: `X-ORION-Key` (forceKey: true). Returns `401` / `403` otherwise.
