...
const FROM = "ORION <noreply@orion.app>";
const ADMIN_EMAIL = "elie@orion.app";
...
function featureCardsHtml(planKey: string): string {
  ...
  // Pro plans: signature-first grid — leads with ORION Analyst, Custom Widgets, MCP
  ...
  return `
      <tr>
        <td style="width: 50%; padding: 12px; vertical-align: top;">
          <div style="background: #111; border: 1px solid #1a1a1a; padding: 16px; height: 100%;">
            <div style="font-size: 20px; margin-bottom: 8px;">&#129302;</div>
            <div style="font-size: 13px; font-weight: 700; color: #fff; margin-bottom: 4px;">ORION Analyst</div>
...
function userWelcomeHtml(planName: string, planKey: string): string {
  ...
  const ctaHref = isPro ? "https://orion.app/brief" : "https://orion.app";
