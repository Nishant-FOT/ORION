 ...
 *   - server/orion/cyber/v1/_shared.ts
 *   - server/orion/military/v1/get-usni-fleet-report.ts
 *   - server/orion/news/v1/_shared.ts  (+ dedup.mjs + hash.ts)
 *   - server/orion/infrastructure/v1/get-cable-health.ts
 *
...
import {
  ...
  SEVERITY_RANK,
  type RawThreat,
} from '../server/orion/cyber/v1/_shared.ts';
...
} from '../server/orion/military/v1/get-usni-fleet-report.ts';
import type { USNIFleetReport } from '../src/generated/server/orion/military/v1/service_server.ts';

// ---------------------------------------------------------------------------
// News domain helpers
// ---------------------------------------------------------------------------
import { deduplicateHeadlines } from '../server/orion/news/v1/dedup.mjs';
import { buildArticlePrompts, hashString } from '../server/orion/news/v1/_shared.ts';
...
import {
  ...
  processNgaSignals,
  computeHealthMap,
} from '../server/orion/infrastructure/v1/get-cable-health.ts';
