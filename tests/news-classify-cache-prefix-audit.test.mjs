...
//   1. server/orion/intelligence/v1/_shared.ts — canonical writer
//      (CLASSIFY_CACHE_PREFIX constant + buildClassifyCacheKey helper)
//   2. server/orion/news/v1/list-feed-digest.ts — digest reader
...
const sharedSrc = readFileSync(
  resolve(repoRoot, 'server/orion/intelligence/v1/_shared.ts'),
  'utf-8',
);
