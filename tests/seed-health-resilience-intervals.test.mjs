...
const originalEnv = {
  ...
  ORION_VALID_KEYS: process.env.ORION_VALID_KEYS,
...
process.env.ORION_VALID_KEYS = 'test-key';
...
async function readSeedHealth() {
  const req = new Request('https://api.orion.app/api/seed-health', {
    headers: { 'X-ORION-Key': 'test-key' },
  });
