...
type MapContainer = {
  ...
  setConflictEvents(events: unknown[]): void;
  setEarthquakes(data: unknown): void;
  setNaturalEvents(data: unknown): void;
  setProtests(events: unknown[]): void;
  setWeatherAlerts(alerts: unknown): void;
};
...
import { ConflictServiceClient } from '@/generated/client/orion/conflict/v1/service_client';
