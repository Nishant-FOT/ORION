export const PANEL_SPANS_KEY = 'orion-panel-spans';
export const PANEL_COL_SPANS_KEY = 'orion-panel-col-spans';
export const PANEL_COLLAPSED_KEY = 'orion-panel-collapsed';
