...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'orion-live-channels',
  'orion-active-channel',
  'orion-runtime-feature-toggles',
  'orion-globe-render-scale',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('orion-variant') || 'full',
    data,
  };
  ...
  a.download = `orion-settings-${ts}.json`;
