...
const STORAGE_KEY = 'orion-globe-render-scale';
const EVENT_NAME = 'orion-globe-render-scale-changed';

const TEXTURE_STORAGE_KEY = 'orion-globe-texture';
const TEXTURE_EVENT_NAME = 'orion-globe-texture-changed';
...
const PRESET_STORAGE_KEY = 'orion-globe-visual-preset';
const PRESET_EVENT_NAME = 'orion-globe-visual-preset-changed';
