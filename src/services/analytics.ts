...
// data-domains is temporarily reduced to orion.app + happy.orion.app
...
// mechanism that keeps energy.orion.app silent. Restore tech, finance, and
// commodity once #4183 ships in a tagged release.
const UMAMI_DOMAINS = 'orion.app,happy.orion.app';
...
const EVENTS = {
  ...
  // ORION Analyst dashboard control
 ...
 */
const SIGNUP_TRACKED_KEY_PREFIX = 'orion-signup-tracked:';
