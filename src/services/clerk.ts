...
// clerk.orion.app — a `clerk-load-failed` there is environmental
// (Great-Firewall-class), not actionable, and not a Clerk-CDN-outage
// signal (ORION-T7). A real CDN outage still alarms via every
 ...
 * Create Account click (ORION-SC / -SD: ~2.3k events / ~1k users).
 *
