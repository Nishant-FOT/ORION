...
const STORAGE_KEY_BROWSER_MODEL = 'orion-ai-flow-browser-model';
const STORAGE_KEY_CLOUD_LLM = 'orion-ai-flow-cloud-llm';
const STORAGE_KEY_MAP_NEWS_FLASH = 'orion-map-news-flash';
const STORAGE_KEY_HEADLINE_MEMORY = 'orion-headline-memory';
const STORAGE_KEY_BADGE_ANIMATION = 'orion-badge-animation';
const STORAGE_KEY_STREAM_QUALITY = 'orion-stream-quality';
