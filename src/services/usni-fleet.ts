import type { MilitaryVessel, MilitaryVesselCluster, MilitaryVesselType, USNIFleetReport, USNIVesselEntry } from '@/types';
...
export function mergeUSNIWithAIS(
  ...
  for (const usniVessel of usniReport.vessels) {
    ...
    merged.push({
      ...
      vesselType: usniVessel.vesselType as MilitaryVesselType,
