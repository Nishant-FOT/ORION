...
export const NUCLEAR_FACILITIES: NuclearFacility[] = [
  ...
  { id: 'novaya_zemlya', name: 'Novaya Zemlya',   lat: 73.37, lon: 54.78,   type: 'test-site', status: 'decommissioned', operator: 'RU' },
  // --- SE ---
  ...
  { id: 'zaporizhzhia', name: 'Zaporizhzhia Nuclear Power Plant', lat: 47.51, lon: 34.59, type: 'plant', status: 'active', operator: 'UA', operationalSince: '1984', treaties: ['NPT (1994, Ukraine)'], iaeaStatus: 'IAEA monitoring mission active', keyEvents: ['Mar 4, 2022: Russian forces seized plant', 'Sep 2022: IAEA permanent monitoring mission established', '2023: Reactors in cold shutdown'] },
  // --- US ---
