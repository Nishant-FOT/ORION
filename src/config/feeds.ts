...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  'live-news': [
    { name: 'Reuters', url: rss('https://news.google.com/rss/search?q=site:reuters.com+when:1d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'AP News', url: rss('https://feeds.apnews.com/rss/apf-topnews') },
    { name: 'BBC World', url: rss('https://feeds.bbci.co.uk/news/world/rss.xml') },
    { name: 'CNN', url: rss('https://rss.cnn.com/rss/edition_world.rss') },
    { name: 'Al Jazeera', url: rss('https://www.aljazeera.com/xml/rss/all.xml') },
    { name: 'Guardian World', url: rss('https://www.theguardian.com/world/rss') },
    { name: 'Bloomberg', url: rss('https://news.google.com/rss/search?q=site:bloomberg.com+when:1d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'FT', url: rss('https://news.google.com/rss/search?q=site:ft.com+when:1d&hl=en-US&gl=US&ceid=US:en') },
  ],
};
...
// Energy variant feeds — energy.orion.app
...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  topical: { labelKey: 'header.sourceRegionTopical', feedKeys: ['energy', 'tech', 'ai', 'finance'] },
  ...
  techPolicy: { labelKey: 'header.sourceRegionTechPolicy', feedKeys: [] },
  techMedia: { labelKey: 'header.sourceRegionTechMedia', feedKeys: ['podcasts', 'finance'] },
