...
export const REFRESH_INTERVALS = {
  ...
  strategicPosture: 30 * 1000, // 30s — near-real-time for live posture
...
export const STORAGE_KEYS = {
  ...
  disabledFeedsSchema: 'orion-disabled-feeds-schema',
  liveChannels: 'orion-live-channels',
  mapMode: 'orion-map-mode',          // 'flat' | 'globe'
  activeChannel: 'orion-active-channel',
  webcamPrefs: 'orion-webcam-prefs',
} as const;
