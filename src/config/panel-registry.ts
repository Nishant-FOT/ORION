...
export const PANEL_REGISTRY: PanelConfig[] = [
  ...
  { id: 'country-deep-dive', name: 'Country Deep Dive', category: 'analysis', icon: 'search', description: 'Detailed country analysis', defaultEnabled: true, priority: 3, defaultWidth: 1, defaultHeight: 1 },
  { id: 'country-timeline', name: 'Country Timeline', category: 'analysis', icon: 'timeline', description: 'Country event timeline', defaultEnabled: true, priority: 4, defaultWidth: 1, defaultHeight: 1 },
  { id: 'historical-intel', name: 'Historical Intelligence', category: 'analysis', icon: 'history_edu', description: 'Historical context analysis', defaultEnabled: true, priority: 5, defaultWidth: 1, defaultHeight: 1 },
  { id: 'regional-intel', name: 'Regional Intelligence', category: 'analysis', icon: 'public', description: 'Regional intelligence board', defaultEnabled: true, priority: 6, defaultWidth: 1, defaultHeight: 1 },
  { id: 'forecast', name: 'Forecast', category: 'analysis', icon: 'auto_graph', description: 'Predictive forecasting', defaultEnabled: true, priority: 7, defaultWidth: 2, defaultHeight: 1 },
  { id: 'geopolitical-risk', name: 'Geopolitical Risk', category: 'analysis', icon: 'globe', description: 'Geopolitical risk assessment', defaultEnabled: true, priority: 8, defaultWidth: 2, defaultHeight: 1 },
  { id: 'chat-analyst', name: 'Chat Analyst', category: 'analysis', icon: 'chat', description: 'AI chat analyst', defaultEnabled: true, priority: 9, defaultWidth: 1, defaultHeight: 1 },
  { id: 'mcp-data', name: 'MCP Data', category: 'analysis', icon: 'database', description: 'MCP protocol data panel', defaultEnabled: true, priority: 10, defaultWidth: 1, defaultHeight: 1 },
  { id: 'correlation', name: 'Correlation Engine', category: 'analysis', icon: 'compare_arrows', description: 'Cross-domain correlation', defaultEnabled: true, priority: 11, defaultWidth: 1, defaultHeight: 1 },
  { id: 'military-correlation', name: 'Military Correlation', category: 'analysis', icon: 'shield', description: 'Military event correlation', defaultEnabled: true, priority: 12, defaultWidth: 1, defaultHeight: 1 },
  { id: 'escalation-correlation', name: 'Escalation Correlation', category: 'analysis', icon: 'trending_up', description: 'Escalation pattern analysis', defaultEnabled: true, priority: 13, defaultWidth: 1, defaultHeight: 1 },
  { id: 'economic-correlation', name: 'Economic Correlation', category: 'analysis', icon: 'account_balance', description: 'Economic event correlation', defaultEnabled: true, priority: 14, defaultWidth: 1, defaultHeight: 1 },
  { id: 'disaster-correlation', name: 'Disaster Correlation', category: 'analysis', icon: 'warning', description: 'Disaster event correlation', defaultEnabled: true, priority: 15, defaultWidth: 1, defaultHeight: 1 },
  { id: 'cii', name: 'Country Instability Index', category: 'analysis', icon: 'assessment', description: 'Country instability scoring', defaultEnabled: true, priority: 16, defaultWidth: 1, defaultHeight: 1 },
  { id: 'cascade', name: 'Cascade Analysis', category: 'analysis', icon: 'waterfall_chart', description: 'Event cascade modeling', defaultEnabled: true, priority: 17, defaultWidth: 1, defaultHeight: 1 },
  { id: 'quantitative-risk', name: 'Quantitative Risk', category: 'analysis', icon: 'calculate', description: 'Quantitative risk metrics', defaultEnabled: true, priority: 18, defaultWidth: 1, defaultHeight: 1 },
  { id: 'scenario-simulator', name: 'Scenario Simulator', category: 'analysis', icon: 'science', description: 'What-if scenario modeling', defaultEnabled: true, priority: 19, defaultWidth: 1, defaultHeight: 1 },
  { id: 'hero-spotlight', name: 'Hero Spotlight', category: 'analysis', icon: 'star', description: 'Featured intelligence item', defaultEnabled: true, priority: 20, defaultWidth: 1, defaultHeight: 1 },
  { id: 'positive-news', name: 'Positive News', category: 'analysis', icon: 'sentiment_satisfied', description: 'Positive news feed', defaultEnabled: false, priority: 21, defaultWidth: 1, defaultHeight: 1 },
  { id: 'good-things', name: 'Good Things Digest', category: 'analysis', icon: 'favorite', description: 'Uplifting news digest', defaultEnabled: false, priority: 22, defaultWidth: 1, defaultHeight: 1 },
  { id: 'breakthroughs', name: 'Breakthroughs', category: 'analysis', icon: 'emoji_events', description: 'Technology breakthroughs', defaultEnabled: false, priority: 23, defaultWidth: 1, defaultHeight: 1 },
  { id: 'species-panel', name: 'Species Comeback', category: 'analysis', icon: 'pets', description: 'Conservation success stories', defaultEnabled: false, priority: 24, defaultWidth: 1, defaultHeight: 1 },
