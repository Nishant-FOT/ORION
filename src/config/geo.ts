import type { Hotspot, ConflictZone, MilitaryBase, StrategicWaterway } from '@/types';
...
export const STRATEGIC_WATERWAYS: StrategicWaterway[] = [
  ...
  { id: 'red_sea',          chokepointId: 'red_sea',          name: 'RED SEA',            lat: 20.0,   lon: 38.0,   description: 'Major transit route to Suez Canal, Houthi threat zone' },
];
...
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  },
  {
    ...
    casualties: 'Limited (skirmishes)',
    displaced: 'N/A',
    keywords: ['korea', 'dmz', 'dmz', 'armistice', 'dprk', 'rok', 'demilitarized', 'infiltration', 'tunnel'],
    keyDevelopments: ['North Korean infiltration tunnels discovered', 'Periodic border skirmishes', 'Joint Security Area incidents', 'Landmine removal operations'],
