...
} from '../../../../src/generated/server/orion/leads/v1/service_server';
import { ApiError, ValidationError } from '../../../../src/generated/server/orion/leads/v1/service_server';
...
export const DESKTOP_AUTH_TIMESTAMP_HEADER = 'x-orion-desktop-timestamp';
export const DESKTOP_AUTH_SIGNATURE_HEADER = 'x-orion-desktop-signature';
export const DESKTOP_AUTH_WINDOW_MS = 5 * 60 * 1000;
const DESKTOP_AUTH_SECRET_ENV = 'ORION_DESKTOP_SHARED_SECRET';
...
// authenticated with HMAC headers when ORION_DESKTOP_SHARED_SECRET is configured;
...
async function sendConfirmationEmail(email: string, referralCode: string): Promise<void> {
  const referralLink = `https://orion.app/pro?ref=${referralCode}`;
  const shareText = encodeURIComponent("I just joined the ORION Pro waitlist \u2014 real-time global intelligence powered by AI. Join me:");
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the ORION Pro waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: "You\u2019re on the ORION Pro waitlist",
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="padding: 40px 32px 0;">
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto 32px;">
                <tr>
                  <td style="width: 40px; height: 40px; vertical-align: middle;">
                    <img src="https://www.orion.app/favico/android-chrome-192x192.png" width="40" height="40" alt="ORION" style="border-radius: 50%; display: block;" />
                  </td>
              ...
              <div style="text-align: center; margin-bottom: 36px;">
                <a href="https://orion.app/dashboard" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 14px 36px; text-decoration: none; font-weight: 800; font-size: 13px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 2px;">Explore the Free Dashboard</a>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              <div style="margin-bottom: 16px;">
                ...
                <a href="https://github.com/orion-energy-resilience/orion" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">GitHub</a>
                <a href="https://orion.app/pro" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">Pro Waitlist</a>
              </div>
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                ORION \u2014 Real-time intelligence for a connected world.<br />
